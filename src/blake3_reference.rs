//! In-tree BLAKE3 reference implementation (Section 5.1 of the BLAKE3 spec).
//! Source: <https://github.com/BLAKE3-team/BLAKE3> — reference_impl/reference_impl.rs (CC0 / public domain).
//! Slightly adapted: `pub(crate)` visibility and `hash_32` helper for this crate.
#![allow(dead_code)]
// Keyed / derive-key paths mirror upstream; this crate only uses `Hasher::new` in TV-B3 today.
...
/// Incremental BLAKE3 hasher (standard hash mode).
pub struct Hasher {
...
/// One-shot 32-byte BLAKE3 hash.
pub(crate) fn hash_32(input: &[u8]) -> [u8; 32] {
